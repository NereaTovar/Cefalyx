...
//   //Edit Attack in server
//   const handleUpdateAttack = async (updatedAttack: AttackListType) => {
//     try {
//       const response = await axios.put(`${apiUrl}/api/attacks/${updatedAttack._id}`, updatedAttack),
//       setAttacks((prev)=>
//         prev.mal((attack)=>
//           attack._id ===updatedAttack._id ? response.data : attack
//         ));
//         setEditAttack(null);
//     }catch (error) {
//       console.error ("Error updateing attack:", error)
//     }
//   }
