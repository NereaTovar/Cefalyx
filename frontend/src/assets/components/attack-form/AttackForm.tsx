...
//   onCancel: () => void; // Para cancelar la edición
// }
...
const AttackForm = ({ addAttack, initialData, onSubmit, onCancel }: AttackFormProps) => {
  const apiUrl =
    import.meta.env.API_URL ||
    "https://cefalyx-nereas-projects-2a045b48.vercel.app";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formattedData: AttackFormType = {
      ...formData,
      type: capitalizedType,
      date: attackDate.toISOString(), // Convertir fecha a string
    };
